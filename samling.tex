...
\entry{2 dec 2017 - De svagaste får ta mest  stryk}{\say{Någonstans runt 15 000 personer i landet berörs av Försäkringskassans tolkningar av de domar som tagits i Högsta förvaltningsdomstolen. Det som drabbar dem är ett oerhört stort lidande. Det är ett hån. Det är ett straff.}
...
\entry{14 dec 2017 - Finansdepartementet och LSS-eländet}{Reglerna om personlig assistans för svårt funktionshindrade tillämpas från 2016 på ett hårdare sätt. Följderna av en av de mer uppmärksammade ändringarna har undersökts av Socialstyrelsen. Att barn, och därmed även föräldrar, drabbats särskilt är inte en missuppfattning från kritikerna.

Tvärtom bekräftas detta i Socialstyrelsens granskning. De fall där tidigare statliga assistansbeslut upphävts, och ärenden stjälpts över på kommuner gäller till 40 procent barn, dubbelt upp mot deras andel i befolkningen.}{https://www.ekuriren.se/kronikor/finansdepartementet-och-lss-elandet/}

\entry{14 dec 2017 - TCO kräver granskning av Försäkringskassan}{Nu protesterar ordföranden Eva Nordmark och tre andra tunga TCO-företrädare mot Försäkringskassans många avslag på sjukpenningen. De sjuka hamnar mellan stolarna när de inte har återfått sin arbetsförmåga och ändå skickas till Arbetsförmedlingen. De fyra kräver att regeringen ser över hur Försäkringskassan bedömer arbetsförmågan.}{https://www.arbetarskydd.se/nyhetsarkiv/tco-kraver-granskning-av-forsakringskassan-6888971}

\entry{14 dec 2017 - Sofia Mirjamsdotter: Varken regeringen eller oppositionen bryr sig om de sjuka}{De regleringsbrev som Försäkringskassan får från regeringen och som till stor del styr över vilka beslut som fattas har gjort det betydligt svårare att få sjukpeng, och även detta har fått hård kritik, inte minst från läkare som upplever sig maktlösa när deras rekommendationer ignoreras och deras patienter tvingas i arbete innan de är redo för det, alternativt hänvisas till socialtjänsten för sin försörjning. En ordning som knappast får någon att bli friskare, men som däremot direkt bidrar till sämre hälsa inte minst för dem som är sjukskrivna för psykiska besvär.}{http://www.st.nu/opinion/ledare/sofia-mirjamsdotter-varken-regeringen-eller-oppositionen-bryr-sig-om-de-sjuka}

\entry{15 dec 2017 - \say{Som att stångas mot en bergsvägg}}{Katarina Bergström gick från hundra procent sjukskriven till hundra procent arbetsför på en natt.}{\detokenize{http://sverigesradio.se/sida/artikel.aspx?programid=91&artikel=6843270}}

\entry{16 dec 2017 - I 30 år har jag räddat liv i Dalarna – efter två minuter vägrar Försäkringskassan mig rehabilitering}{Då slår samhället i form av Försäkringskassan tillbaka. Efter två minuter på telefon dömer man ut min chans att rehabiliteras. Man anser att jag ska gå till Arbetsförmedlingen i stället för att beviljas deltidssjukskrivning i knappt tre månader. 25000 kronor sparar för samhället på detta sätt – pengar som räcker tre dar för stafettläkaren som ersätter mig. Fast det klart – denne slipper ju Försäkringskassan betala.}{http://www.dt.se/dalarna/debatt-i-30-ar-har-jag-raddat-liv-i-dalarna-efter-tva-minuter-vagrar-forsakringskassan-mig-rehabilitering}

\entry[DRJ3FuOW0AIQRlv]{16 dec 2017}{Ny artikel i BMC Public Health visar att patienter inte blir friska av att bli av med sjukersättning. Något för Försäkringskassan? \#SvMECFS}{https://twitter.com/StenHelmfrid/status/941946214920093697}

\entry{17 dec 2017 - Partiets stenhårda önskelista till Löfven}{Vi vill ha en tryggare sjukförsäkring än i dag. Som det ser ut nu är det väldigt, väldigt många som inte får sin sjukdom godkänd så att man inte får någon sjukersättning, säger Marie Nilsson.

Från IF Metalls håll var förhoppningen stor när regeringen avskaffade ”stupstocken”, den bortre parentesen i sjukförsäkringen, förra året.

– Vi trodde då att det skulle bli mer rättssäkert och tryggt men det har visat sig att det inte är så utan att det i stället är väldigt många som får avslag på sin ansökan om ersättning, fast de är för sjuka för att arbeta.}{https://www.aftonbladet.se/nyheter/samhalle/a/qnL210/partiets-stenharda-onskelista-till-lofven}

\entry{17 dec 2017}{1. Ska det här bli veckan då regeringen ser till att Försäkringskassan upphör med sina rättsosäkra bedömningar av sjuka människors arbetsförmåga? Det är en skamfläck för en välfärdsstat. Sjuka människor behöver trygghet, inte en ekonomisk giljotin. Skärpning!}{https://twitter.com/RantaJens/status/942620586693550080}

\entry{18 dec 2017 - Helene fick en stroke men förväntas jobba heltid}{Alltfler sjuka överklagar att de blir av med sin sjukpenning eftersom de inte förstår hur Försäkringskassan bedömer deras arbetsförmåga. Hör ögonsjuksköterskan Helene Ydenius som fick en stroke för fyra år sedan i ett reportage. Reportage av Anna-Karin Sivberg.}{\detokenize{http://sverigesradio.se/sida/artikel.aspx?programid=1650&artikel=6845004}}

\entry{18 dec 2017 - Fler överklagar avslag på sjukpenning}{Den fackliga juristbyrån LO-TCO Rättsskydd har hittills i år hjälpt 330 personer att överklaga, drygt 200 fler än hela fjolåret.

\ldots

För en korrekt bedömning som är rättssäker behöver man titta på faktiska jobb som finns, som vaktmästare och receptionist. Men så gör inte Försäkringskassan, de gör fiktiva arbeten som få människor har möjlighet att förstå, säger han till Ekot.}{https://arbetet.se/2017/12/18/fler-overklagar-avslag-pa-sjukpenning/}

\entry{18 dec 2017 - Ompröva tidsgränserna i sjukförsäkringen}{Mycket tyder på att 180-dagarsgränsen i sjukförsäkringen är det som gör att sjuka utförsäkras. Definitionen av vilket slags arbete man väntas kunna ta då måste bli tydligare – så att det inte handlar om låtsasjobb.}{http://www.dagensarena.se/opinion/omprova-tidsgranserna-sjukforsakringen/}

\entry{18 dec 2017 - Sjukskrivna förstår inte vilka \say{lätta jobb} de ska ta}{Allt fler sjukskrivna överklagar att de blivit av med sin sjukpenning. Det stora problemet är att de sjuka inte förstår vad det är för slags arbeten som deras arbetsförmåga ska bedömas mot.}{\detokenize{http://sverigesradio.se/sida/artikel.aspx?programid=83&artikel=6841524}}

\entry{18 dec 2017 - S bör tänka om kring sjukskrivningarna}{Det är en moderat älsklingstanke, detta att \say{bidrag} – alltså socialförsäkringar som ger ett någorlunda rimligt ekonomiskt skydd vid sjukdom eller arbetslöshet – bara gör folk lata och arbetsskygga.

Det faktiska stödet för de här idéerna saknas. Den bortre parentes för sjukskrivningar som alliansen införde ledde inte till att långvarigt sjukskrivna kom tillbaka i arbete – bara att de fick förlita sig på anhöriga, eller kommunens socialtjänst, för sin försörjning.}{http://www.ostrasmaland.se/ledare/s-bor-tanka-om-kring-sjukskrivningarna/}


\entry{18 dec 2017 - Socialministern: \say{Ser att det gnisslar väldigt mycket}}{Många förstår inte Försäkringskassans beslut om sjukersättning. Socialminister Annika Strandhäll vill se över saken.

Allt fler överklagar Försäkringskassans beslut om sjukpenning och ögonsjuksköterskan Helene Ydenius är en av dem. Försäkringskassan bedömer att hon kan arbeta heltid, trots att hennes läkarintyg talar om en arbetsförmåga på 25 procent. Uppmaningen från Försäkringskassan är att söka \say{ett lättare jobb utan stress}.}{\detokenize{http://sverigesradio.se/sida/artikel.aspx?programid=83&artikel=6845032}}

\entry{18 dec 2017 - Hur känns det att vara handläggare på Försäkringskassan}{Hur känns det att välja att varje dag i sitt liv gå till ett arbete där man vet att man förstör livet för en eller flera medmänniskor – \say{man följer reglerna}? Att befinna sig i en slags Sophies val-situation varje dag. Nej, jag tänker inte försvara handläggarna, jag bara undrar hur man kan leva med sig själv när \say{jobbet} handlar om att sparka på de svagaste}{https://bigpaublog.wordpress.com/2017/12/18/hur-kanns-det-att-vara-handlaggare-pa-forsakringskassan/}

\entry{18 dec 2017 - Skadade 36-åringar utan pengar – Timmy var för ung, Johnny för gammal}{ALLT FÄRRE FÅR HJÄLP VID ARBETSSKADOR
Snickaren Timmy, 36, var för ung för att vara arbetsskadad, tyckte Försäkringskassan. Betongarbetaren Johnny, också 36, var för gammal. Läs om ett absurt system och om två värkande byggryggar.}{http://www.byggnadsarbetaren.se/2017/12/den-sjuka-forsakringen-det-kanns-som-ett-skamt/}

\entry{18 dec 2017 - Ministern lovar snabb översyn av tuffa sjukregler}{Allt fler sjukskrivna överklagar att de blivit av med sin sjukpenning. \say{Vi har de tuffaste reglerna i hela OECD}, säger socialminister Annika Strandhäll (S) som lovar presentera ett åtgärdspaket efter årsskiftet.

\ldots

Andelen som får avslag på sjukpenning har ökat kraftigt de senaste åren. I juni avslog Försäkringskassan 13 procent av pågående sjukfall, jämfört med 6 procent 2015.}{http://www.dagensarena.se/innehall/ministern-lovar-snabb-oversyn-av-tuffa-sjukregler/}

\entry{18 dec 2017 - Bryter tystnaden om försäkringskassan}{}{http://entrepoja.maqt.se/2017/12/18/bryter-tystnaden-om-forsakringskassan/}

\entry{19 dec 2017 - Vad i helsike är ett normalt jobb?}{Vad är det för jobb Försäkringskassans personal tänker sig att dessa sjuka och skadade människor ska kunna utföra? Ja, sanningen är att dessa normalt förekommande jobb inte finns. De är bara fiktiva låtsasjobb som Försäkringskassans personal hittar på för att klara sitt besparingsbeting.

Frågan om låtsasjobben kommer att behandlas i Högsta förvaltningsdomstolen under nästa år. Det är bra att frågan prövas, ännu bättre vore det förstås om den ansvariga ministern Annika Strandhäll såg över lagen. Det är inte klokt att en svensk myndighet tillåts arbeta med sådana här låtsasbegrepp.}{https://www.aftonbladet.se/a/7lKaMv}

\entry{19 dec 2017 - Försäkringskassan: \say{Läkarna måste beskriva vad som hindrar arbete}}{Personal på onkologiska kliniken vid USÖ märker en ökad oro och att fler cancerpatienter får avslag på sin ansökan om sjukpenning.}{https://www.svt.se/nyheter/lokalt/orebro/forsakringskassan-valkomnar-att-de-vill-ha-dialog}

\entry{19 dec 2017 - Johanna överlevde cancern – nu kämpar hon mot Försäkringskassan}{28 år och diagnosticerad med aggressiv bröstcancer – Johanna Pettersson har kämpat för att bli frisk. Vad hon inte hade räknat med var den resultatlösa kampen mot Försäkringskassans regler.}{https://www.svt.se/nyheter/lokalt/orebro/johanna-overlevde-cancern-nu-kampar-hon-mot-forsakringskassan}

\entry{19 dec 2017 - När är botten nådd?}{Jag läste en artikeln i Norran den 7 december där Försäkringskassan stolt meddelade att sjukskrivningarna i kommunen minskat kraftigt och att samarbetet med Arbetsförmedling och arbetsgivare fungerar bra.

Som anhörig undrar jag vilken värld befinner sig ledningen för Försäkringskassan.

Den bild Försäkringskassa ger stämmer inta alls överens med min erfarenhet.

Läkare sliter sitt hår i förtvivlan över att de många intygen de tvingas skriva ratas, arbetsförmedlingens handläggare skakar uppgivet på sina huvuden när uppenbart svårt sjuka människor tvingas anmäla sig som arbetssökande, arbetsgivare som vill och kräver möten med Försäkringskassan ignoreras.}{http://norran.se/asikter/insandare/insandare-forsakringskassan-bild-av-verkligheten-stammer-inte-alls-946917}

\entry{19 dec 2017 - Kuratorer i protest mot sjukskrivningsregler: \say{Cancerpatienter drabbas}}{Att få ett cancerbesked är ofta chockartat och många människor hamnar i kris. Att dessutom behöva vänta länge på besked om sjukskrivning eller sjukpenning ökar på stressen för de flesta. Nu skriver onkologerna på USÖ ett brev till regeringen där de protesterar mot Försäkringskassans regler.}{https://www.svt.se/nyheter/lokalt/orebro/kuratorer-skriver-protestbrev}

\entry{19 dec 2017 - \say{Försäkringskassan har hittat på egna regler}}{Fler får numera avslag på ansökan om sjukpenning. När ansvarig minister Annika Strandhäll menar att skälet enbart är fler prövningar, stämmer det inte. Försäkringskassan följer egna interna regler med hårdare tillämpning. En ordentlig genomlysning av detta är nu nödvändig, skriver Tom Aspengren, förbundsjurist vid LO-TCO Rättsskydd.}{https://www.svd.se/forsakringskassan-har-hittat-pa-egna-regler}

\entry{20 dec 2017 - Mikael fick inte sjukpenning – trots läkarutlåtande: \say{Jag har haft så jäkla ont att tårarna har runnit}}{}{https://www.fagersta-posten.se/logga-in/mikael-fick-inte-sjukpenning-trots-lakarutlatande-jag-har-haft-sa-jakla-ont-att-tararna-har-runnit}


\entry{20 dec 2017 - Sjukförsäkringen har gått sönder i Sverige}{När man skriver om sjukförsäkringen får man många mail, och en del telefonsamtal. De kommer från människor som förlorar sig själva, sin känsla av människovärde och sin tillit till välfärdsstaten i och med de beslut som fattas om deras sjukpenning. Ett av de senaste jag fick skrevs direkt från psykakuten, där en man befann sig efter flera självmordsförsök och sammanbrott direkt kopplat till sjukpenningavslag. Han fann bland annat sig själv på sin båt med ankarkättingen virad runt benet, stirrande ner i vattnet, men fick gudskelov så småningom hjälp av sina anhöriga att söka vård.}{http://www.politism.se/story/sjukforsakringen-har-gatt-sonder-i-sverige}

\entry{20 dec 2017 - Professor: Systemet är inte rättssäkert}{Trots att lagstiftningen förblir densamma ändrar Försäkringskassan tillämpningen av reglerna efter tongångarna i Rosenbad. \say{Det är inte rättssäkert}, säger professor Ruth Mannelqvist.}{https://www.etc.se/inrikes/professor-systemet-ar-inte-rattssakert}

\entry{20 dec 2017 - Ingen sjukpenning om du klarar hemarbete}{– Försäkringskassan vill att arbete i hemmet, där man kan byta arbetsställning och ta paus när man vill, ska ses som normalt förekommande arbete. Det upplever nog många som verklighetsfrånvänt, kommenterar Robert Sjunnebo, jurist och enhetschef vid LO TCO Rättsskydd.
...
– Försäkringskassan söker alla möjligheter att neka människor sjukpenning.}{https://arbetet.se/2017/12/20/ingen-sjukpenning-om-du-klarar-hemarbete/}

\entry{20 dec 2017 - Johanna, 28, är inte frisk efter bröstcancern – utförsäkras}{För drygt ett år sedan diagnosticerades Johanna Pettersson med svår bröstcancer.

Nu har hon utförsäkrats och tvingas leva på 4 000 kronor i månaden efter skatt, något som SVT var först med att skriva om.

– Jag gick på cellgifter när Försäkringskassan ringde mig och sa att \say{nu ska du förbereda dig inför jobb}, berättar Johanna.}{https://www.expressen.se/nyheter/johanna-28-ar-inte-frisk-efter-brostcancern-utforsakras/}

\entry{20 dec 2017 - Strokedrabbade Micke tvingas bo på anstalt}{Fyra dagar före jul tvingas funktionshindrade Micke in på anstalt.
...
– Jag har slutat gråta nu, säger hon.}{https://www.aftonbladet.se/ledare/a/BJlpge/strokedrabbade-micke-tvingas-bo-pa-anstalt}

\entry{20 dec 2017 - Vi behöver en sjukförsäkring som inte gör sjuka fattiga}{För sossarna räcker det dock inte med att gå emot de borgerligas stupstock än gång till. Nu gäller det att övertyga väljarna om att visionen om välfärdssamhället fortfarande lever. Då kan inte sjuka tvingas att söka jobb som inte finns eller som de i varje fall aldrig kan få. Ingen av oss kan ju förutse när sjukdom eller olyckor drabbar oss. Sjukförsäkringen ska därför fungera för oss alla.}{http://www.ltz.se/opinion/ledare/vi-behover-en-sjukforsakring-som-inte-gor-sjuka-fattiga}

\entry{20 dec 2017 - Debatt: Centerpartiet: Regeringen försöker få ned sjuktalen genom att neka människor ersättning}{Försäkringskassan avslår ansökningar om sjukersättning för att minska sjuktalen. Avslagen ligger nu på den högsta nivån sedan 2009. Drygt 22 000 avslag av pågående sjukfall gjordes under 2016. De som överklagar besluten får vänta i ett halvår utan ersättning. Hur många klarar ett halvår utan inkomst?

Försäkringskassan har regeringens uppdrag att minska kostnaderna för sjukskrivningarna. Läkarnas sjukintyg ifrågasätts och följden blir att patienter nekas ersättning på tveksamma grunder. Ofta handlar det om psykisk ohälsa. Att avslå ansökningar på tveksamma grunder är omänskligt. Försäkringskassan har ansvaret för att processen förs framåt. Men enligt Inspektionen för Socialförsäkring, ISF, brister Försäkringskassan i bedömningarna i rehabiliteringsprocessen.}{http://www.dalademokraten.se/opinion/debatt/debatt-centerpartiet-regeringen-forsoker-fa-ned-sjuktalen-genom-att-neka-manniskor-ersattning}

\entry{21 dec 2017 - Socialdemokraterna sparar på sjuka för att vinna valet 2018}{Socialdemokraterna är kallt beräknande och övertygade om att de breda reformerna och den stränga migrationspolitiska linjen kommer leda till valseger och väga tyngre för väljarna än det faktum att människor kastas ut ur Sverige, blir utan assistans och inte ens får ha cancer i fred utan att ha Försäkringskassan flåsandes i telefonluren och brevinkastet.}{http://www.arbetarbladet.se/opinion/ledare/socialdemokraterna-sparar-pa-sjuka-for-att-vinna-valet-2018}

\entry{21 dec 2017}{Tung dag! Först sambo och nu medarbetare som ringde mig, storgråtandes, och berättade att FK nekat sjukskrivning. Båda djupt deprimerade. God Jävla Jul \#socialdemokrat \#strandhall}{https://twitter.com/valbloggnu/status/943906545326350338}

\entry{21 dec 2017 - Sluta straffa de sjuka!​}{Målsättningen som sattes kring sänkta sjuktal kan vara ett av de sämsta politiska beslut som någonsin har fattats. Att dessutom ge Försäkringskassan i uppdrag att bidra var än värre. Att avslagsfrekvensen beträffande sjukpenning ökade i samband med beslutet om det satta målet är näppeligen ett slumpartat samband.}{https://www.lararforbundet.se/bloggar/lararforbundets-utredarblogg/sluta-straffa-de-sjuka}

\entry{22 dec 2017 - Mina barn får inga julklappar i år – är vi med diagnos inte värda något längre?}{}{http://www.st.nu/opinion/insandare/mina-barn-far-inga-julklappar-i-ar-ar-vi-med-diagnos-inte-varda-nagot-langre}

\entry{22 dec 2017}{Kan @fk_media förklara hur man tänker när man nekar sjukpenning till en som inte är medicinskt rehabiliterad och därmed inte har rätt förutsättningar att återgå i arbete? Nä men får man inte operation inom 365 dagar så är man arbetsför. What?!}{https://twitter.com/RegadoJ/status/944133995494825984}

\entry{22 dec 2017}{Jag ska försöka att ta lite jullov från politiskt twittrande men först vill jag att ni ska tänka lite på min fd fackkollega som går hemma sjukskriven över jul, men utan ersättning pga att kassan inte godtar läkarintyget.}{https://twitter.com/Skolinkvisition/status/944218613216694272}

\entry{22 dec 2017 - Forskare: Kostnadsproblemet är påhittat för att motivera allmänna besparingar}{Så flyttade regeringen fokus från allas lika värde till besparingar. Kostnadsproblemet med assistans är konstruerat för att motivera allmänna besparingar. Sparåtgärderna är inte effektiva mot vare sig fusk eller övervinster. Det hävdar forskaren Niklas Altermark i en artikel i Socialvetenskaplig tidskrift.}{https://hejaolika.se/artikel/forskare-kostnadsproblemet-ar-pahittat-att-motivera-allmanna-besparingar}

\entry{23 dec 2017 - Sjuka lärare uppmanas säga upp sig – trots lärarbrist}{Försäkringskassans allt hårdare tolkningar slår hårt mot sjuka lärare.

Den som varit sjukskriven 180 dagar uppmanas säga upp sig – och söka andra jobb.

– Ett allvarligt övertramp! I lärarkrisens Sverige måste den som blivit sjuk av sitt jobb få en vettig chans att komma tillbaka, säger Johanna Jaara Åstrand, ordförande i Lärarförbundet.}{https://www.aftonbladet.se/nyheter/samhalle/a/8w62a1/sjuka-larare-uppmanas-saga-upp-sig--trots-lararbrist}

\entry{23 dec 2017 - Susanna är utbildad lärare men uppmanas söka andra jobb}{Susanna Winborg, 33, har kämpat sig tillbaka i jobb på 75 procent.

Men Försäkringskassan avslår hennes deltidssjukskrivning – och slår fast att hon ska söka andra jobb på heltid.

– Jag ifrågasatte och sa att jag ju är utbildad lärare och har tagit studielån för det. Då fick jag till svar: Vi kan inte ta hänsyn till ditt yrke, säger Susanna Winborg.}{https://www.aftonbladet.se/nyheter/samhalle/a/8w6gnE}

\entry{23 dec 2017}{Alltfler av våra medlemmar hamnar mellan stolarna. Regeringen måste ta ett helhetsgrepp på sjukförsäkringen. I lärarkrisens Sverige är det vettlöst att den som blivit sjuk av sitt jobb inte får en rimlig chans att komma tillbaka. \#svpol \#arbetsmiljö}{https://twitter.com/JohannaJAstrand/status/944495528565460992}

\entry{23 dec 2017}{Omställningsstöd om 50.000kr i månaden under 365 dagar för riksdagsledamöter anses rimligt. Det anses också vara rimligt med indragen sjukpenning efter 180 dagar.}{https://twitter.com/Antitesen/status/944523291817140225}

\entry{23 dec 2017}{Vi kommer att fortsätta skrika tills ni hör! @strandhall

\say{Hon menar att hennes medlemmar drabbas dubbelt – både av den dåliga arbetsmiljön men också av att de nekas ersättning när de inte orkar längre.}}{https://twitter.com/ar817817/status/944522393598521344}

\entry{23 dec 2017}{Önskar er alla en fin och God Jul Riktar en extra tanke till alla dem inblandade ansvariga den dysfunktionella inhumana \#socialförsäkringen som nu ska avnjuta julskinkan brottandes m samvete \& faktumet att många sjuka o i behov assistens där ute ej äger den lyxen. Må ni grubbla.}{https://twitter.com/PalmqvistAsa/status/944580035381514240}

\entry{24 dec 2017}{Min man är lärare. Han gör en höftledsoperation, tre månaders sjukskrivning. Försäkringskassan ringer efter ett par månader och säger att han bör söka annat jobb. Frågan är nu, törs han operera den andra höften nu? \#mänskligareFK}{https://twitter.com/GrannyRoom/status/944841474142818307}

\entry{25 dec 2017 - Min sjukdom är ingenting mot kampen med oärliga handläggare}{När mina synpunkter väl är hos handläggaren säger hon att mina ord i detta inte betyder någonting. Jag frågar vad hon behöver och får då till mig att jag har ett ”dåligt” läkarintyg, det saknas uppgifter där och att min läkare inte undersökt mig regelbundet under det gångna året. Jag skäms då jag meddelar min kompetenta läkare detta. Jag känner att de kränker hennes kompetens. Min läkare tar kontakt med handläggaren angående ”luckorna” i sjukintyget och handläggaren svarar att hon inte behöver ytterligare kompletteringar i mitt ärende. Någonstans här går jag sönder inombords. Ord står mot ord och handläggaren är allt annat än ärlig.}{http://www.allehanda.se/opinion/insandare/min-sjukdom-ar-ingenting-mot-kampen-med-oarliga-handlaggare-1}

\entry{25 dec 2017 - Förnya samhälle och sluta sparka på den som redan ligger}{Det här handlar om människor som har varit sjukskrivna. Försäkringskassan har utrett och har tidigare accepterat sjukintygen för dem.

Socialdemokraterna gick till val med påstående att de skulle sluta avstänga sjuka människor ur hela vår trygghetssystem. Nu lever socialdemokraterna inte upp till löftet utan gör precis tvärtom. Fyra procent (4 \%) av läkarintygen godkänns ej, enligt Tankesmedjan Balans. Jag har lyssnat till läkare på en vårdcentral som påstår att siffran är bra mycket högre.

Min uppfattning efter att ha samtalat med läkare är att läkarintygen trots allt är relevanta, men att försäkringskassan underkänner dessa. Konsekvenserna blir att sjukskrivna människor blir friskskrivna och skickas till arbetsförmedlingen}{http://norran.se/asikter/insandare/insandare-fornya-samhalle-och-sluta-sparka-pa-den-som-redan-ligger-949489}

\entry{26 dec 2017 - Debatt: Fusket i LSS är överdrivet – vi behöver stå upp för en utsatt grupp}{Man kan lätt få uppfattningen att assistans är synonymt med fusk. Men vid närmare granskning verkar den siffran tagen ur luften. Detta då den utredning som tillsatts rörande saken inte är klar och tidigare utredning som gjorts med hjälp av polis- samt åklagarmyndighet påvisar fusk på en nivå av 0,2 promille av den totala kostnaden för hela assistansreformen.}{http://www.dalademokraten.se/opinion/debatt/debatt-fusket-i-lss-ar-overdrivet-vi-behover-sta-upp-for-en-utsatt-grupp}

\entry{27 dec 2017 - Funkisbarn ska inte hamna på hem igen}{Den allra viktigaste faktorn för ett barns välmående är sannolikt att få växa upp i en familj. Den villkorslösa kärleken, tryggheten, tillhörigheten och det nära samspelet med en eller ett par vuxna och kanske andra barn är helt avgörande. Vi vet att barn som växer upp på barnhem får djupa sår, och såväl FN:s barnkonvention som konventionen om rättigheter för personer med funktionsnedsättningar slår fast att alla barn har rätt att växa upp i en familj.

Ändå pågår en utveckling i Sverige som leder till att allt fler barn tvingas växa upp på institutioner. Och det är dessutom de barn som har störst behov, och kanske allra svårast att i en institutionsmiljö hävda sitt människovärde.}{https://www.aftonbladet.se/debatt/a/OnQV9V/funkisbarn-ska-inte-hamna-pa-hem-igen}

\entry{28 dec 2017 - Insändare: Är den som nekas sjukpenning verkligen fullt frisk?}{Hur tolkar handläggare på Försäkringskassan i Skellefteå dessa lagar och regler då de sätter sig över de diagnoser som en utbildad och erfaren läkare ställer för att kunna behandla sin patient?

Vilken kunskap tillämpas när handläggare avslår en ansökan om sjukpenning trots en utbildad och erfaren läkares bedömning att patienten är i behov av sjukskrivning och därmed sjukpenning?}{http://norran.se/asikter/insandare/insandare-ar-den-som-nekas-sjukpenning-verkligen-fullt-frisk-951250}

\entry{29 dec 2017 - Efterlyser tydlighet}{Nuvarande konstruktion och styrning av sjukförsäkringen är minst sagt dysfunktionell. Regeringen behöver göra en generell översyn av hela sjukförsäkringssystemet. I dag utgår systemet på många sätt utifrån hur arbetsmarknaden såg ut på 50-talet, säger Marina Tuutma.}{https://www.dagensmedicin.se/artiklar/2017/12/29/efterlyser-tydlighet-fran-forsakringskassan/}

\entry{29 dec 2017}{Rättssäkerhet har två dimensioner, formell och materiell. Formell rättssäkerhet tar sikte på förutsebarhet, likabehandling och rättslikhet. Materiell rättssäkerhet tar sikte på att beslutet ska vara gott, etiskt riktigt och syfta till att uppfylla lagstiftningens syften.

I debatten betonas den formella sidan på bekostnad av den materiella. Det hela förvärras av att t ex Försäkringskassan regelbundet missbrukar begreppet rättssäkerhet och reducerar det till att handla om rättslikhet: om alla behandlas lika illa är det förutsebart och rättssäkert.

Införandet av rättssäkerhet skulle i själva verket revolutionera Försäkringskassans beslutsfattande. Det skulle betyda att alla fick goda och etiskt riktiga beslut som syftar till att förverkliga sociallagstiftningens syften. Se där en nyårsbön och ett handlingsprogram för 2018.}{https://twitter.com/WelfareStateLaw/status/946805105348808704}

\entry{29 dec 2017}{Vem känner att de får stöd och bemötts med empati när Försäkringskassan friskförklarar en sjuk person mot dennes vilja? Vilket stöd erbjuder myndigheten den försäkrade vars möjlighet till försörjning dras in under pågående rehabilitering? Vari finns värdigheten att bli ifrågasatt och inte få något gehör för de synpunkter som den försäkrade inkommer med under kommuniceringstiden? På vilket vis får den försäkrade inflytande över sin livssituation när Arbetsförmedlingen nekar denne hjälp för att den försäkrade är för sjuk, samtidigt som Försäkringskassan bedömer att personen är fullt arbetsför? Det finns således anledning att reflektera över huruvida Försäkringskassan verkligen uppfyller sina åtaganden.}{http://marie-louise-aijkens.se/forsakringskassan/}

\entry{30 dec 2017}{Jag låg vaken i natt (som alla andra nätter) och var upprörd över regleringsbrevet 2018 till FK. Jag kommer alltid att vara den där som kom i kläm \& ramlat mellan stolarna p.g.a att jag bor där jag är tvingad att bo och inte får hjälp med det jag behöver hjälp med.}{https://twitter.com/Junabacka/status/947041568921399296}

\entry{31 dec 2017 - \say{Ni behandlar inte de sjuka med någon empati alls.}}{Och nej samarbetet fungerar inte mellan försäkringskassan, Arbetsförmedlingen och hälso- och sjukvård. Det är min absoluta erferenhet.

När min läkare i flera års tid försökt få kontakt, skrivit detta på varje läkarintyg, ringt och försökt få tag i handläggare. Sista gången hon ringde fick hon tag i en beslutsfattande handläggare som avslagit min ansökan om sjukersättning för andra gången som vi ansökt om nu sedan april 2015.

Då sa denna beslutsfattande handläggare bara att \say{är ni missnöjda kan ni begära omprövning}!? Så var det med det samarbetet!

Det fungerar inte alls!}{http://norran.se/asikter/insandare/ni-behandlar-inte-de-sjuka-med-nagon-empati-alls-3-952992}


\entry{2 jan 2018 - Försäkringskassan uppmanar Minna att säga upp sig}{Minna Helander är en av allt fler som slängs ut ur sjukförsäkringen.
Hon får inte sjukpenning - trots att arbetsgivare, fack och läkare är på hennes sida.

Minna Helander från Nossebro råkade ut för en svår trafikolycka för ett år sedan.
Hon behöver ytterligare några månaders rehabilitering innan hon är helt återställd och kan gå tillbaka till sitt ordinarie jobb.
Men Försäkringskassan bryr sig inte om Minnas läkarintyg – istället blir hon av med sjukpenningen.

– Jag känner mig väldigt ledsen. Allt jag vill är att bygga upp min styrka så jag kan återgå till mitt jobb, säger hon.}{\detokenize{http://sverigesradio.se/sida/artikel.aspx?programid=97&artikel=6845639}}

\entry{2 jan 2018 - Brukare kan stå utan personliga assistenter}{Assistenter som slutar när assistanstimmarna blir färre gör att brukare helt kan stå utan hjälp.}{\detokenize{http://sverigesradio.se/sida/artikel.aspx?programid=91&artikel=6851227}}

\entry{2 jan 2018 - Antalet sjukskrivna gotlänningar minskar}{Nej, det är inte så att vi kan tolka sjukskrivningstalen som direkta hälsoförändringar}{http://www.helagotland.se/samhalle/antalet-sjukskrivna-gotlanningar-minskar-15016195.aspx}

\entry{2 jan 2018 - Försäkringskassan frångår prejudicerade domar och rättspraxis}{Vid den tidpunkten skriver Försäkringskassans (FK) juridikavdelning att:
...
Numera struntar FK i den tolkningen och har antagit egna regler för bedömning av sjukpenning.}{https://arbetet.se/2018/01/02/forsakringskassan-frangar-prejudicerade-domar-och-rattspraxis/}

\entry{3 jan 2018 - INSÄNDARE: Kan någon som jobbar på Försäkringskassan sova en enda natt med gott samvete?}{Inget har blivit bättre på senare år utan människor slås sönder av andra människor som arbetar på en svensk myndighet.

Kan någon tjänsteman eller kvinna som har sitt arbete och därvid också sitt uppehälle genom Försäkringkasan sova någon natt med god sömn och gott samvete (i Finland där jag har mitt ursprung sade man att ett gott samvete var den bästa huvudkudden)?

Ingen människa skall kunna använda sitt arbete för att begå sådana näst intill kriminella åtgärder mot en medmänniska som Försäkringskassan och dess personal begår.}{http://www.avestatidning.com/opinion/insandare/insandare-kan-nagon-som-jobbar-pa-forsakringskassan-sova-en-enda-natt-med-gott-samvete}

\entry{5 jan 2018 - Efter att läkaren Anders uppmanades söka nytt jobb – facket kritiserar Försäkringskassan: \say{Det är absurt}}{}{https://www.dt.se/logga-in/efter-att-lakaren-anders-uppmanades-soka-nytt-jobb-facket-kritiserar-forsakringskassan-det-ar-absurt}

\entry{5 jan 2018 - Är fånge i sitt eget hem}{34 tabletter. Det äter Niclas Ek dagligen för att hålla smärtan och psyket någorlunda stången.
Kamp för ersättning. I ett snart halvt decennium har Niclas Ek varit sjukskriven efter sviterna av en blodpropp i benet.
– Det jobbigaste är ovissheten om Försäkringskassan kommer att fortsätta betala ut någon sjukpenning. Jag är för sjuk för att kunna gå kunna till Arbetsförmedlingen, säger han.}{https://mariestadstidningen.se/toreboda/2018/01/05/ar-fange-i-sitt-eget-hem}

\entry{6 jan 2018 - Minna fick 19 frakturer – får inte vara sjukskriven}{Minna Helander råkade ut för en svår trafikolycka för ett år sedan. Hon fick 19 frakturer – och en är ännu inte helt läkt.

Trots att hon behöver ytterligare rehabilitering har Försäkringskassan dragit in sjukpenningen.

– De har uppmanat mig att säga upp mig och söka ett annat jobb, säger hon.}{https://www.expressen.se/gt/minna-fick-19-frakturer-far-inte-vara-sjukskriven/}
